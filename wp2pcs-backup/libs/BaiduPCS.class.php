...
class BaiduPCS {
	...
	// 在baseControl的基础上抓取远方的内容
	private function _getControl($url,$trimjson = true) {
	...
	public function getQuota() {
		$result = $this->_getControl("https://pcs.baidu.com/rest/2.0/pcs/quota?method=info&access_token=".$this->_accessToken);
		return $result;
	}
